...
def main():
    client = Web3(Web3.HTTPProvider("https://bsc-dataseed.binance.org/"))
    start_key = 800000000
    stop_key = 0xfffffffff
    filename = "BNB.txt"
    ...
    for key_int in range(start_key, stop_key + 1):
        ...
        data = f'Address: {address} | Balance: {balance} BNB | Private Key: {private_key_hex}'
        print(data)
